...
const initAssets = async () => {
    // Default state assets
    await saveFile('default_icon', 'assets/icons/app-state/default.svg');
    await saveFile('default_bg', 'assets/images/background/app-state/default.jpg');
